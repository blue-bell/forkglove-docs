...
Log in to [Foxglove](https://app.foxglove.dev), and navigate to the [Webhooks settings page](https://app.foxglove.dev/~/settings/webhooks/).
...
Click your newly created webhook on the [Webbhooks settings page](https://app.foxglove.dev/~/settings/webhooks/), and trigger a `ping` event to test its connectivity.
